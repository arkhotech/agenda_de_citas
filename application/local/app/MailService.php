...
class MailService { 
    ...
    public function sendMail($from, $subject, $body, $to)
    {
        ...
        try {
            ...
            $response_token = null; // Ojo Borrar
            ...
            if ($response_token === null) {                
                ...
                if ($response_token->getStatusCode() == 200) {
                    ...
                    Cache::put($cache_id, $response_token, $ttl);
                }
            }
            ...
            if ($response_token->getStatusCode() == 200) {
                ...
                $response = Request::post($urlSendMail)
                    ->addHeaders(array('Authorization' => 'Bearer ' . $acces_token))
                    ->expectsJson()
                    ->sendsJson()
                ...
                $res['error'] = true;
                $res['errorMessage'] = $res['error_description'];
            }
